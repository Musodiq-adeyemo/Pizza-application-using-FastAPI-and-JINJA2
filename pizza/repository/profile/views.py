...
from pizza.models.database import Profile,User
from pizza.models.schemas import CreateProfile
...
def delete_profile(id:int,db:Session,Authorize:AuthJWT = Depends()):
    ...
    if user.id == delete_profile.user :
        ...
        raise HTTPException(status_code=status.HTTP_401_UNAUTHORIZED,detail="Sorry you are not Authorized to delete this profile")
