...
from pizza.models.schemas import Login,Settings
from sqlalchemy.orm import Session
from pizza.models.database import get_db,User
...
def refresh_login(Authorize:AuthJWT=Depends()):
    ...
    new_access_token = Authorize.create_access_token(subject=current_user,fresh=True,expires_time=new_access_token_expire,algorithm=access_algorithm)
